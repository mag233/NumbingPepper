...
import { CheckCircle2, Loader2, ShieldCheck, TestTube, Wifi } from 'lucide-react'
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-sm font-semibold text-ink-primary">Global Settings</p>
          <p className="text-xs text-ink-muted">Shared by Reader and Writer.</p>
        </div>
