...
| 18.20 | In Progress | P1       | Writer global search | Add a Writer search modal across Content/Context/References/Chat/Studio with click-to-jump | Partial (2026-01-07, `docs/QA.md` 18-QA-033). Issues: (1) Filter UI shows (0) when all off, should show grey counts; (2) References/Studio jump broken. |
