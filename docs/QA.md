...
| ID | Scenario | Steps | Expected | Result | Notes |
| -- | -------- | ----- | -------- | ------ | ----- |
| 33-QA-001 | Selection → Questions auto-send | Select text in Reader → click `Questions` | Chat auto-sends; output is 3–5 `Q:`/`A:` items and includes [Terminology]/[Logic]/[Insight] coverage | Pending |  |
