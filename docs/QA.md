...
| 18-QA-033 | Writer global search | In Writer, click Search; query a term that appears in Content/Context/References/Chat/Studio; toggle filters and click results | Modal returns scoped matches; clicking a result scrolls/focuses the correct area; filters update counts | Pending | Studio results should jump to the artifact row. |
